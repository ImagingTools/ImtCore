...
LIBS += -limtoas -limtbase -limtfile
...
win32-msvc*{
	...
	QMAKE_POST_LINK = $$(QTDIR)\bin\windeployqt $$DESTDIR\OasCodeGeneratorExe.exe --verbose 2
}
...
ARXC_FILES += $$PWD/../OasCodeGeneratorExe.acc
