...
/**
	...
	operations exposed by \c CDocumentServiceController.
	...
	- \c CDocumentServiceBridge: forwards every call directly to an
...
*/
class IDocumentServiceBridge: virtual public istd::IPolymorphic
{
public:
