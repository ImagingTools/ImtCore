...
class COidcClientDbDelegateComp: public imtdb::CSqlDatabaseObjectDelegateCompBase
{
public:
	typedef imtdb::CSqlDatabaseObjectDelegateCompBase BaseClass;

	I_BEGIN_COMPONENT(COidcClientDbDelegateComp)
		I_ASSIGN(m_clientFactCompPtr, "OidcClient", "Factory used for creation of the new OIDC client", true, "OidcClient");
	I_END_COMPONENT
...
private:
	I_FACT(imtauth::IOidcClient, m_clientFactCompPtr);
};
