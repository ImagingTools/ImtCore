...
class CTenantMembershipDbDelegateComp: public imtdb::CSqlDatabaseObjectDelegateCompBase
{
public:
	typedef imtdb::CSqlDatabaseObjectDelegateCompBase BaseClass;

	I_BEGIN_COMPONENT(CTenantMembershipDbDelegateComp)
		I_ASSIGN(m_membershipFactCompPtr, "MembershipFactory", "Factory used for creation of new membership instances", true, "MembershipFactory");
	I_END_COMPONENT
