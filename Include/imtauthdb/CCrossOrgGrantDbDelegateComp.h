...
class CCrossOrgGrantDbDelegateComp: public imtdb::CSqlDatabaseObjectDelegateCompBase
{
public:
	typedef imtdb::CSqlDatabaseObjectDelegateCompBase BaseClass;

	I_BEGIN_COMPONENT(CCrossOrgGrantDbDelegateComp)
		I_ASSIGN(m_grantFactCompPtr, "GrantFactory", "Factory used for creation of cross-org grant instances", true, "GrantFactory");
	I_END_COMPONENT
...
private:
	I_FACT(imtauth::ICrossOrgGrantData, m_grantFactCompPtr);
};
