...
class CTenantRelationshipProposalDbDelegateComp: public imtdb::CSqlDatabaseObjectDelegateCompBase
{
public:
	typedef imtdb::CSqlDatabaseObjectDelegateCompBase BaseClass;

	I_BEGIN_COMPONENT(CTenantRelationshipProposalDbDelegateComp)
		I_ASSIGN(m_proposalFactCompPtr, "ProposalFactory", "Factory used for creation of relationship proposal instances", true, "ProposalFactory");
	I_END_COMPONENT
...
private:
	I_FACT(imtauth::ITenantRelationshipProposalData, m_proposalFactCompPtr);
};
