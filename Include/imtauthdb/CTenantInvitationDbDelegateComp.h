...
class CTenantInvitationDbDelegateComp: public imtdb::CSqlDatabaseObjectDelegateCompBase
{
public:
	typedef imtdb::CSqlDatabaseObjectDelegateCompBase BaseClass;

	I_BEGIN_COMPONENT(CTenantInvitationDbDelegateComp)
		I_ASSIGN(m_invitationFactCompPtr, "InvitationFactory", "Factory used for creation of tenant invitation instances", true, "InvitationFactory");
	I_END_COMPONENT
...
private:
	I_FACT(imtauth::ITenantInvitation, m_invitationFactCompPtr);
};
