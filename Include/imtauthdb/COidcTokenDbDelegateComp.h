...
class COidcTokenDbDelegateComp: public imtdb::CSqlDatabaseObjectDelegateCompBase
{
public:
	typedef imtdb::CSqlDatabaseObjectDelegateCompBase BaseClass;

	I_BEGIN_COMPONENT(COidcTokenDbDelegateComp)
		I_ASSIGN(m_tokenFactCompPtr, "OidcTokenInfo", "Factory used for creation of the new OIDC token info", true, "OidcTokenInfo");
	I_END_COMPONENT
...
private:
	I_FACT(imtauth::IOidcTokenInfo, m_tokenFactCompPtr);
};
