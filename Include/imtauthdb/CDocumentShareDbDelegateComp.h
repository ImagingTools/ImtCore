...
class CDocumentShareDbDelegateComp: public imtdb::CSqlDatabaseObjectDelegateCompBase
{
public:
	typedef imtdb::CSqlDatabaseObjectDelegateCompBase BaseClass;

	I_BEGIN_COMPONENT(CDocumentShareDbDelegateComp)
		I_ASSIGN(m_shareFactCompPtr, "ShareFactory", "Factory used for creation of document share instances", true, "ShareFactory");
	I_END_COMPONENT
...
private:
	I_FACT(imtauth::IDocumentShareData, m_shareFactCompPtr);
};
