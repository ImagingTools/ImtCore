...
class CTenantConnectionDbDelegateComp: public imtdb::CSqlDatabaseObjectDelegateCompBase
{
public:
	typedef imtdb::CSqlDatabaseObjectDelegateCompBase BaseClass;

	I_BEGIN_COMPONENT(CTenantConnectionDbDelegateComp)
		I_ASSIGN(m_connectionFactCompPtr, "ConnectionFactory", "Factory used for creation of connection instances", true, "ConnectionFactory");
	I_END_COMPONENT
...
private:
	I_FACT(imtauth::ITenantConnectionData, m_connectionFactCompPtr);
};
