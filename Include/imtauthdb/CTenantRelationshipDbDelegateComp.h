...
class CTenantRelationshipDbDelegateComp: public imtdb::CSqlDatabaseObjectDelegateCompBase
{
public:
	typedef imtdb::CSqlDatabaseObjectDelegateCompBase BaseClass;

	I_BEGIN_COMPONENT(CTenantRelationshipDbDelegateComp)
		I_ASSIGN(m_relationshipFactCompPtr, "RelationshipFactory", "Factory used for creation of relationship instances", true, "RelationshipFactory");
	I_END_COMPONENT
...
private:
	I_FACT(imtauth::ITenantRelationshipInfo, m_relationshipFactCompPtr);
};
