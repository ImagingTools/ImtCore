...
class CTenantConnectionCodeDbDelegateComp: public imtdb::CSqlDatabaseObjectDelegateCompBase
{
public:
	typedef imtdb::CSqlDatabaseObjectDelegateCompBase BaseClass;

	I_BEGIN_COMPONENT(CTenantConnectionCodeDbDelegateComp)
		I_ASSIGN(m_codeFactCompPtr, "CodeFactory", "Factory used for creation of connection code instances", true, "CodeFactory");
	I_END_COMPONENT
