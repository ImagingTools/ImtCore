...
class CTenantEntityBindingDbDelegateComp: public imtdb::CSqlDatabaseObjectDelegateCompBase
{
public:
	typedef imtdb::CSqlDatabaseObjectDelegateCompBase BaseClass;

	I_BEGIN_COMPONENT(CTenantEntityBindingDbDelegateComp)
		I_ASSIGN(m_bindingFactCompPtr, "BindingFactory", "Factory used for creation of tenant entity binding instances", true, "BindingFactory");
	I_END_COMPONENT
...
private:
	I_FACT(imtauth::ITenantEntityBinding, m_bindingFactCompPtr);
};
