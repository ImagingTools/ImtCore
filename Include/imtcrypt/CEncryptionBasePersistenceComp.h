...
/**
	Interface describing saving an encrypted file
	\ingroup Cryptography
*/
class CEncryptionBasePersistenceComp: public icomp::CComponentBase, virtual public ifile::IFilePersistence

{
public:
	typedef icomp::CComponentBase BaseClass;

	I_BEGIN_COMPONENT(CEncryptionBasePersistenceComp);
