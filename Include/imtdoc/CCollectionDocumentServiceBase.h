...
class CCollectionDocumentServiceBase: public ilog::CLoggerComponentBase, virtual public CDocumentServiceBase
{
public:
	typedef ilog::CLoggerComponentBase BaseClass;
	typedef CDocumentServiceBase BaseClass2;

	I_BEGIN_BASE_COMPONENT(CCollectionDocumentServiceBase)
