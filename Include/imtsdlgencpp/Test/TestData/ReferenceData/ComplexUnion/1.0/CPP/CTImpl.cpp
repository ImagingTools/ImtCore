...
sdl::complextest::CTImpl::CExtendedMetaDataUnionSimpleTypeObject* CUnionTestingTypeObject::GetSimpleUnion()
{
	if (Version_1_0->simpleUnion.has_value()){
		if (!m_simpleUnionQObjectPtr){
			m_simpleUnionQObjectPtr = dynamic_cast<sdl::complextest::CTImpl::CExtendedMetaDataUnionSimpleTypeObject*>(CreateObject("simpleUnion"));
...
void CUnionTestingTypeObject::SetSimpleUnion(sdl::complextest::CTImpl::CExtendedMetaDataUnionSimpleTypeObject* v)
{
	if (v){
...
sdl::complextest::CTImpl::CCDMResultUnionTypeObject* CUnionTestingTypeObject::GetComplexUnion()
{
	if (Version_1_0->complexUnion.has_value()){
		if (!m_complexUnionQObjectPtr){
			m_complexUnionQObjectPtr = dynamic_cast<sdl::complextest::CTImpl::CCDMResultUnionTypeObject*>(CreateObject("complexUnion"));
...
void CUnionTestingTypeObject::SetComplexUnion(sdl::complextest::CTImpl::CCDMResultUnionTypeObject* v)
{
	if (v){
...
sdl::complextest::CTImpl::CExtendedMetaDataUnionTypeObject* CUnionTestingTypeObject::GetMixedUnion()
{
	if (Version_1_0->mixedUnion.has_value()){
		if (!m_mixedUnionQObjectPtr){
			m_mixedUnionQObjectPtr = dynamic_cast<sdl::complextest::CTImpl::CExtendedMetaDataUnionTypeObject*>(CreateObject("mixedUnion"));
...
void CUnionTestingTypeObject::SetMixedUnion(sdl::complextest::CTImpl::CExtendedMetaDataUnionTypeObject* v)
{
	if (v){
...
QObject* CUnionTestingTypeObject::CreateObject(const QString& key)
{
	...
	if (key == "complexUnion"){
		return new sdl::complextest::CTImpl::CCDMResultUnionTypeObject(this);
	}
	if (key == "mixedUnion"){
		return new sdl::complextest::CTImpl::CExtendedMetaDataUnionTypeObject(this);
	}
