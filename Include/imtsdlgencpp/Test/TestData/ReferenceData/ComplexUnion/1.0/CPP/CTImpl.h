...
{
	Q_OBJECT
	Q_PROPERTY(sdl::complextest::CTImpl::CExtendedMetaDataUnionSimpleTypeObject* m_simpleUnion READ GetSimpleUnion WRITE SetSimpleUnion NOTIFY simpleUnionChanged)
	Q_PROPERTY(sdl::complextest::CTImpl::CCDMResultUnionTypeObject* m_complexUnion READ GetComplexUnion WRITE SetComplexUnion NOTIFY complexUnionChanged)
	Q_PROPERTY(sdl::complextest::CTImpl::CExtendedMetaDataUnionTypeObject* m_mixedUnion READ GetMixedUnion WRITE SetMixedUnion NOTIFY mixedUnionChanged)
...
public:
	...
	sdl::complextest::CTImpl::CExtendedMetaDataUnionSimpleTypeObject* GetSimpleUnion();
	void SetSimpleUnion(sdl::complextest::CTImpl::CExtendedMetaDataUnionSimpleTypeObject* v);
	Q_INVOKABLE bool hasSimpleUnion();
	Q_INVOKABLE void createSimpleUnion();
	sdl::complextest::CTImpl::CCDMResultUnionTypeObject* GetComplexUnion();
	void SetComplexUnion(sdl::complextest::CTImpl::CCDMResultUnionTypeObject* v);
	Q_INVOKABLE bool hasComplexUnion();
	Q_INVOKABLE void createComplexUnion();
	sdl::complextest::CTImpl::CExtendedMetaDataUnionTypeObject* GetMixedUnion();
	void SetMixedUnion(sdl::complextest::CTImpl::CExtendedMetaDataUnionTypeObject* v);
...
protected:
	sdl::complextest::CTImpl::CExtendedMetaDataUnionSimpleTypeObject* m_simpleUnionQObjectPtr;
	sdl::complextest::CTImpl::CCDMResultUnionTypeObject* m_complexUnionQObjectPtr;
	sdl::complextest::CTImpl::CExtendedMetaDataUnionTypeObject* m_mixedUnionQObjectPtr;
};


class CUnionTestingTypeObjectList: public ::imtbase::TListModelBase<sdl::complextest::CTImpl::CUnionTestingType::V1_0, sdl::complextest::CTImpl::CUnionTestingTypeObject>
{
	Q_OBJECT
	Q_PROPERTY(int count READ rowCount() NOTIFY countChanged())
public:
	typedef ::imtbase::TListModelBase<sdl::complextest::CTImpl::CUnionTestingType::V1_0, sdl::complextest::CTImpl::CUnionTestingTypeObject> BaseClass;
	...
	Q_INVOKABLE void append(sdl::complextest::CTImpl::CUnionTestingTypeObject* item){
		beginInsertRows(QModelIndex(), rowCount(), rowCount());
		Version_1_0->append(*item->Version_1_0);
		ClearCache();
		endInsertRows();
	}
	Q_INVOKABLE sdl::complextest::CTImpl::CUnionTestingTypeObjectList* copyMe(){
		sdl::complextest::CTImpl::CUnionTestingTypeObjectList* objectListPtr = new sdl::complextest::CTImpl::CUnionTestingTypeObjectList();

		for (int i = 0; i < this->rowCount(); i++){
			QVariant item = this->getData("item", i);
			if (!item.canConvert<sdl::complextest::CTImpl::CUnionTestingTypeObject>()){
				return nullptr;
			}

			sdl::complextest::CTImpl::CUnionTestingTypeObject* itemObjectPtr = item.value<sdl::complextest::CTImpl::CUnionTestingTypeObject*>();
			if (itemObjectPtr == nullptr){
				return nullptr;
			}

			objectListPtr->addElement(dynamic_cast<sdl::complextest::CTImpl::CUnionTestingTypeObject*>(itemObjectPtr->copyMe()));
		}
	...
	Q_INVOKABLE void addElement(sdl::complextest::CTImpl::CUnionTestingTypeObject* item){
		append(item);
	}
	...
	Q_INVOKABLE bool isEqualWithModel(sdl::complextest::CTImpl::CUnionTestingTypeObjectList* otherModelPtr){
		if (otherModelPtr == nullptr){
			return false;
		}
		...
		for (int i = 0; i < this->rowCount(); i++){
			QVariant selfItem = this->getData("item", i);
			QVariant otherItem = otherModelPtr->getData("item", i);
			if (!selfItem.canConvert<sdl::complextest::CTImpl::CUnionTestingTypeObject>()){
				return false;
			}

			sdl::complextest::CTImpl::CUnionTestingTypeObject* selfItemObjectPtr = selfItem.value<sdl::complextest::CTImpl::CUnionTestingTypeObject*>();
			if (selfItemObjectPtr == nullptr){
				return false;
			}

			sdl::complextest::CTImpl::CUnionTestingTypeObject* otherItemObjectPtr = selfItem.value<sdl::complextest::CTImpl::CUnionTestingTypeObject*>();
			if (otherItemObjectPtr == nullptr){
				return false;
			}
	...
	Q_INVOKABLE void insert(int index, sdl::complextest::CTImpl::CUnionTestingTypeObject* item){
		if (index < 0 || index > Version_1_0->size()) return;
		beginInsertRows(QModelIndex(), index, index);
		Version_1_0->insert(index, *item->Version_1_0);
		ClearCache();
	...
	Q_INVOKABLE QVariant getData(const QString& nameId, int index){
		if (nameId == "item" && Version_1_0.has_value() && index >= 0 && index < Version_1_0->count()){
			sdl::complextest::CTImpl::CUnionTestingTypeObject* retVal = GetOrCreateCachedObject(index);
			return QVariant::fromValue(retVal);
		}
