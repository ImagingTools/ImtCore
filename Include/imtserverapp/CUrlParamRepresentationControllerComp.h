...
class CUrlParamRepresentationControllerComp:
			public ilog::CLoggerComponentBase,
			public imtserverapp::TJsonRepresentationControllerWrap<sdl::V1_0::imtbase::CUrlParam>
{
public:
...
protected:
	// reimplemented (imtserverapp::TJsonRepresentationControllerWrap<sdl::V1_0::imtbase::CUrlParam>)
