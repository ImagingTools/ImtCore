...
istd::IChangeable* CProductionQualityItem::GetModel()
{
	return m_modelPtr;
}


void CProductionQualityItem::SetModel(istd::IChangeable* modelPtr)
{
	m_modelPtr = modelPtr;
}
...
void CProductionQualityItem::SetStyle(DrawStyle style)
{
	m_style = style;
}
