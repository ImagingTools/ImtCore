...
CFeaturePackageCollectionControllerComp::CFeaturePackageCollectionControllerComp()
	: imtguigql::CObjectCollectionControllerCompBase()
{

}

imtbase::CTreeItemModel *CFeaturePackageCollectionControllerComp::ListObjects(const imtgql::CGqlRequest &gqlRequest, QString &errorMessage) const
{
