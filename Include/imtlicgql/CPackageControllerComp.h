...
protected:
	...
	void InsertSubFeaturesToDataFromModel(imtlic::IFeatureInfo* parentFeaturePtr, const imtbase::CTreeItemModel* subFeaturesModel) const;
	void InsertSubFeaturesToModelFromData(const imtlic::IFeatureInfo* parentFeaturePtr, imtbase::CTreeItemModel* subFeaturesModel) const;
};
