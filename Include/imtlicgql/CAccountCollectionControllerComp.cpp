...
CAccountCollectionControllerComp::CAccountCollectionControllerComp()
	: imtguigql::CObjectCollectionControllerCompBase()
{

}

imtbase::CTreeItemModel *CAccountCollectionControllerComp::ListObjects(const imtgql::CGqlRequest &gqlRequest, QString &errorMessage) const
{
...
//			itemsModel->SetData(imtqml::CCommandDataEnumProviderComp::ID, packageId,itemIndex);
			itemsModel->SetData("Account Name", packageName,itemIndex);
