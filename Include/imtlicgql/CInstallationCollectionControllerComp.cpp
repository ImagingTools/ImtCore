...
CInstallationCollectionControllerComp::CInstallationCollectionControllerComp()
	: imtguigql::CObjectCollectionControllerCompBase()
{

}

imtbase::CTreeItemModel *CInstallationCollectionControllerComp::ListObjects(const imtgql::CGqlRequest &gqlRequest, QString &errorMessage) const
{
