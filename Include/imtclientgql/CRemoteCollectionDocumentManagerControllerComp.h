...
class CRemoteCollectionDocumentManagerControllerComp:
			public TClientRequestManagerCompWrap<sdl::imtbase::CollectionDocumentManager::CGraphQlHandlerCompBase>
{
public:
	typedef TClientRequestManagerCompWrap<sdl::imtbase::CollectionDocumentManager::CGraphQlHandlerCompBase> BaseClass;

	I_BEGIN_COMPONENT(CRemoteCollectionDocumentManagerControllerComp);
