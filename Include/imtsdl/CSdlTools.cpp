...
QStringList CSdlTools::GetAutoGeneratedQmlFilePaths(const iprm::IParamsSet& schemaParams, const QString& baseDirPath)
{
	QStringList retVal;
	...
	retVal << GetFileSystemAcceptableEntryPath(baseFilePath + QStringLiteral("qmldir"));
