			...
			ibase::IProgressManager* progressManagerPtr)
{
	...
	if (m_argumentParserCompPtr->IsDependenciesMode()){
		if (m_argumentParserCompPtr->IsAutoJoinEnabled()){
			...
			QStringList qmlFilePaths = GetAutoGeneratedQmlFilePaths(*m_customSchemaParamsCompPtr, m_argumentParserCompPtr->GetOutputDirectoryPath());
			...
			// generated QRC file
			cumulatedFiles << QString(outputDirectoryPath + "/" + GetNamespaceFromParamsOrArguments(m_customSchemaParamsCompPtr, m_argumentParserCompPtr) + ".qrc");
