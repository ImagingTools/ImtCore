...
bool CSdlClassJsonModificatorComp::ProcessHeaderClassFile(const CSdlType& sdlType)
{
...
bool CSdlClassJsonModificatorComp::ProcessSourceClassFile(const CSdlType& sdlType)
{
...
void CSdlClassJsonModificatorComp::AddFieldWriteToJsonCode(QTextStream& stream, const CSdlField& field)
{
	bool isArray = false;
	bool isCustom = false;
...
void CSdlClassJsonModificatorComp::AddFieldReadFromJsonCode(QTextStream& stream, const CSdlField& field)
{
	bool isArray = false;
	bool isCustom = false;
	ConvertType(field, &isCustom, nullptr, &isArray);
...
void CSdlClassJsonModificatorComp::AddCustomFieldWriteToJsonCode(QTextStream& stream, const CSdlField& field)
{
	FeedStream(stream, 1, false);
	FeedStreamHorizontally(stream);
	if (field.IsRequired()){
...
void CSdlClassJsonModificatorComp::AddCustomFieldWriteToJsonImplCode(QTextStream& stream, const CSdlField& field, quint16 hIndents)
{
...
void CSdlClassJsonModificatorComp::AddArrayFieldWriteToJsonImplCode(QTextStream& stream, const CSdlField& field, quint16 hIndents)
{
	FeedStreamHorizontally(stream, hIndents);
...
void CSdlClassJsonModificatorComp::AddCustomFieldReadFromJsonCode(QTextStream& stream, const CSdlField& field)
{
	if (field.IsRequired()){
...
void CSdlClassJsonModificatorComp::AddCustomFieldReadFromJsonImplCode(QTextStream& stream, const CSdlField& field, quint16 hIndents)
{
	FeedStreamHorizontally(stream, hIndents);
...
void CSdlClassJsonModificatorComp::AddArrayFieldReadFromJsonCode(QTextStream& stream, const CSdlField& field)
{
	if (field.IsRequired()){
		AddJsonValueCheckAndConditionBegin(stream, field, false);
		FeedStreamHorizontally(stream, 2);
...
void CSdlClassJsonModificatorComp::AddArrayFieldReadFromJsonImplCode(QTextStream& stream, const CSdlField& field, quint16 hIndents)
{
	FeedStreamHorizontally(stream, hIndents);
	...
	FeedStreamHorizontally(stream, hIndents);
	stream << ConvertType(field) <<  ' ' << listVariableName << ';';
	FeedStream(stream, 1, false);
...
void CSdlClassJsonModificatorComp::AddCustomArrayFieldReadFromJsonCode(QTextStream& stream, const CSdlField& field)
{
	if (field.IsRequired()){
		AddJsonValueCheckAndConditionBegin(stream, field, false);
		FeedStreamHorizontally(stream, 2);
...
void CSdlClassJsonModificatorComp::AddJsonValueCheckAndConditionBegin(QTextStream& stream, const CSdlField& field, bool expected, quint16 hIndents)
{
	FeedStreamHorizontally(stream, hIndents);
	stream << QStringLiteral("if (");
	if (!expected){
