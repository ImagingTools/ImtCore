...
#include <imtaccount/CCompanyBaseInfo.h>
...
istd::IChangeableUniquePtr CCompanyBaseInfo::CloneMe(CompatibilityMode mode) const
{
	istd::IChangeableUniquePtr clonePtr(new CCompanyBaseInfo);
