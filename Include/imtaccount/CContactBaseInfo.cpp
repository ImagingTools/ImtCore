...
#include <imtaccount/CContactBaseInfo.h>
...
istd::IChangeableUniquePtr CContactBaseInfo::CloneMe(CompatibilityMode mode) const
{
	istd::IChangeableUniquePtr clonePtr(new CContactBaseInfo);
