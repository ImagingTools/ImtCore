...
#include <imtaccount/CPersonBaseInfo.h>
...
istd::IChangeableUniquePtr CPersonBaseInfo::CloneMe(CompatibilityMode mode) const
{
	istd::IChangeableUniquePtr clonePtr(new CPersonBaseInfo);
