...
// ImtCore includes
#include <imtrest/IApplicationInfoRepresentation.h>
...
class CApplicationInfoRepresentationComp: public imtrest::IApplicationInfoRepresentation, public ilog::CLoggerComponentBase
{
public:
	...
	virtual bool GetRepresentationFromApplicationInfo(const ibase::IApplicationInfo& applicationInfo, imtbase::CTreeItemModel& representation) const override;
