...
class CDoubleParamRepresentationControllerComp: public imtrest::TJsonRepresentationControllerCompWrap<sdl::imtbase::ImtBaseTypes::CDoubleParam::V1_0>
{
public:
	typedef imtrest::TJsonRepresentationControllerCompWrap<sdl::imtbase::ImtBaseTypes::CDoubleParam::V1_0> BaseClass;

	I_BEGIN_COMPONENT(CDoubleParamRepresentationControllerComp)
	I_END_COMPONENT;

protected:
	// reimplemented (imtrest::TJsonRepresentationControllerCompWrap<sdl::imtbase::ImtBaseTypes::CDoubleParam::V1_0>)
