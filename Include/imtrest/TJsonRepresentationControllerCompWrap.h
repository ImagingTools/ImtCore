...
class TJsonRepresentationControllerCompWrap:
			...
			virtual public imtrest::IJsonRepresentationController
{
public:
	typedef ilog::CLoggerComponentBase BaseClass;
	
	I_BEGIN_BASE_COMPONENT(TJsonRepresentationControllerCompWrap);
		I_REGISTER_INTERFACE(imtrest::IJsonRepresentationController);
...
template<class SdlClass>
imtrest::IJsonRepresentationController::RepresentationInfo TJsonRepresentationControllerCompWrap<SdlClass>::GetRepresentationInfo() const
{
	imtrest::IJsonRepresentationController::RepresentationInfo representationInfo;
