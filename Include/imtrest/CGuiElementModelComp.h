...
class CGuiElementModelComp:
			...
			virtual public imtrest::IGuiElementModel
{
public:
	...
	I_BEGIN_COMPONENT(CGuiElementModelComp);
		...
		I_REGISTER_INTERFACE(imtrest::IGuiElementModel);
	...
	// reimplemented (imtrest::IGuiElementModel)
...
protected:
	...
	I_REF(imtrest::IGuiElementContainer, m_subElementsCompPtr);
};
