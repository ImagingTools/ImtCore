...
bool CApplicationInfoRepresentationComp::GetRepresentationFromApplicationInfo(const ibase::IApplicationInfo& applicationInfo, imtbase::CTreeItemModel& representation) const
{
