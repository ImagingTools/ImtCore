...
class CTagAssignmentDbDelegateComp: public imtdb::CSqlDatabaseObjectDelegateCompBase
{
public:
	typedef imtdb::CSqlDatabaseObjectDelegateCompBase BaseClass;

	I_BEGIN_COMPONENT(CTagAssignmentDbDelegateComp)
		I_ASSIGN(m_assignmentFactCompPtr, "AssignmentFactory", "Factory of tag assignments", true, "AssignmentFactory");
	I_END_COMPONENT
...
private:
	I_FACT(imttag::ITagAssignment, m_assignmentFactCompPtr);
};
