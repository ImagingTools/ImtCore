...
/**
	Delegate of the append-only TagEvents table.
*/
class CTagEventDbDelegateComp: public imtdb::CSqlDatabaseObjectDelegateCompBase
{
public:
	typedef imtdb::CSqlDatabaseObjectDelegateCompBase BaseClass;

	I_BEGIN_COMPONENT(CTagEventDbDelegateComp)
		I_ASSIGN(m_eventFactCompPtr, "EventFactory", "Factory of tag events", true, "EventFactory");
	I_END_COMPONENT
...
private:
	I_FACT(imttag::ITagEvent, m_eventFactCompPtr);
};
