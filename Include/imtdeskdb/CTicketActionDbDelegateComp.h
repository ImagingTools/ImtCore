...
class CTicketActionDbDelegateComp: public imtdb::CSqlDatabaseObjectDelegateCompBase
{
public:
	typedef imtdb::CSqlDatabaseObjectDelegateCompBase BaseClass;

	I_BEGIN_COMPONENT(CTicketActionDbDelegateComp)
		I_ASSIGN(m_ticketActionFactCompPtr, "TicketActionFactory", "Factory used for creation of new ticket action instances", true, "TicketActionFactory");
	I_END_COMPONENT
...
private:
	I_FACT(imtdesk::ITicketAction, m_ticketActionFactCompPtr);
};
