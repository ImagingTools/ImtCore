...
QWidget *CNumericItemDelegate::createEditor(QWidget *parent,
											...
											const QModelIndex &) const
{
	if(m_type == CNumericItemDelegate::SpinInt)
	{
		...
		qDebug() << "createEditor:" << option.rect << option.decorationSize;
		return editor;
	}
...
void CNumericItemDelegate::setEditorData(QWidget *editor,
...
void CNumericItemDelegate::setModelData(QWidget *editor, QAbstractItemModel *model,
										const QModelIndex &index) const
{
...
void CNumericItemDelegate::updateEditorGeometry(QWidget *editor,
