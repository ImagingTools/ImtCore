...
public:
	...
	I_BEGIN_COMPONENT(CMongoDatabaseObjectCollectionComp);
	...
	virtual bool RemoveElement(const Id& elementId,
							   const imtbase::IOperationContext* operationContextPtr = nullptr) override;
...
protected:
	I_REF(imtmongo::IMongoDatabaseEngine, m_mongoDatabaseEngineCompPtr);
