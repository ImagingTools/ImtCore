...
class CMongoDatabaseEngineAttr: public ilog::CLoggerComponentBase
{
public:
	typedef ilog::CLoggerComponentBase BaseClass;
	I_BEGIN_COMPONENT(CMongoDatabaseEngineAttr);
	I_END_COMPONENT;
};


class CMongoDatabaseEngineComp:
			virtual public IMongoDatabaseEngine,
			virtual public CMongoDatabaseEngineAttr
{
public:
	typedef CMongoDatabaseEngineAttr BaseClass;

	I_BEGIN_COMPONENT(CMongoDatabaseEngineComp);
		I_REGISTER_INTERFACE(imtmongo::IMongoDatabaseEngine)
...
private:
	...
	*/
	...
	static Interface* ExtractDatabaseAccessSettings(CMongoDatabaseEngineComp& component)
	{
...
private:
	...
	imtbase::TModelUpdateBinder<imtdb::IDatabaseLoginSettings, CMongoDatabaseEngineComp> m_databaseAccessObserver;
