...
class CConversationDbDelegateComp: public imtdb::CSqlDatabaseObjectDelegateCompBase
{
public:
	typedef imtdb::CSqlDatabaseObjectDelegateCompBase BaseClass;

	I_BEGIN_COMPONENT(CConversationDbDelegateComp)
		I_ASSIGN(m_conversationFactCompPtr, "ConversationFactory", "Factory used for creation of new conversation instances", true, "ConversationFactory");
	I_END_COMPONENT
