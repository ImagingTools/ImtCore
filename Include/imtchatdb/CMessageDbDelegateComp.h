...
class CMessageDbDelegateComp: public imtdb::CSqlDatabaseObjectDelegateCompBase
{
public:
	typedef imtdb::CSqlDatabaseObjectDelegateCompBase BaseClass;

	I_BEGIN_COMPONENT(CMessageDbDelegateComp)
		I_ASSIGN(m_messageFactCompPtr, "MessageFactory", "Factory used for creation of new message instances", true, "MessageFactory");
	I_END_COMPONENT
