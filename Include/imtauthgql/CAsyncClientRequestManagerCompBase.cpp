...
QByteArrayList CAsyncClientRequestManagerCompBase::GetElementIds(const QByteArray& collectionId) const
{
...
bool CAsyncClientRequestManagerCompBase::RemoveElements(const QByteArray& collectionId, const QByteArrayList& elementIds) const
{
	namespace imtcollection = sdl::imtbase::ImtCollection;
