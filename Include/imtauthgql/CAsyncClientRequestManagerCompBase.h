...
class CAsyncClientRequestManagerCompBase:
			public imtclientgql::CAsyncClientRequestManagerCompBase
{
public:
	typedef imtclientgql::CAsyncClientRequestManagerCompBase BaseClass;

	I_BEGIN_COMPONENT(CAsyncClientRequestManagerCompBase)
