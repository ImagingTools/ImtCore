...
class CSelectionConstraintsRepresentationControllerComp: public imtbase::CObjectRepresentationControllerCompBase
{
public:
	typedef imtbase::CObjectRepresentationControllerCompBase BaseClass;

	I_BEGIN_COMPONENT(CSelectionConstraintsRepresentationControllerComp)
	I_END_COMPONENT;
