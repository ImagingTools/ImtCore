	...
	function createComponent(propertyId, typename){
		switch (propertyId){
			case 'm_specification': {
				switch (typename){
					case 'PrinterSpecificationBase': return Qt.createComponent('qrc:/qml/imtbaseComplexCollectionFilterSdl/PrinterSpecificationBase.qml')
					case 'Link': return Qt.createComponent('qrc:/qml/imtbaseComplexCollectionFilterSdl/Link.qml')
				}
			}
		}
	}
