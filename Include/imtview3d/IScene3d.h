...
// ImtCore includes
#include <imtview3d/IScene3dItem.h>
#include <imtview3d/IDrawable.h>
...
public:
	...
	*/
	virtual imtview3d::IScene3dItem* GetShapePtr(const QByteArray& id) const = 0;
	...
	*/
	virtual QByteArray AddShapeToScene(imtview3d::IScene3dItem* objectPtr, int shapeFlags = SF_NONE) = 0;

	/**
		Remove an existing 3D-shape from the scene.
	*/
	virtual void RemoveShapeFromScene(imtview3d::IScene3dItem* objectPtr) = 0;
};
