...
namespace imtgui
{
	...
	void CLayoutManagerComp::OnGuiRetranslate()
	{
		...
		m_startEndEditModeCommand.SetVisuals(tr("Edit Mode"), tr("Edit Mode"), tr("EditMode"), emptyIcon);
	}
...
//// public methods
//
//CLayoutManagerComp::CLayoutManagerComp() 
//{
//}
//
//
...
//
//
//void CLayoutManagerComp::OnGuiDestroyed()
//{
...
//
//void CLayoutManagerComp::OnComponentCreated()
//{
...
//// private methods
//
//void CLayoutManagerComp::UpdateVisualStatus()
//{
