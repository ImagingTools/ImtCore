...
class CGqlSettingsControllerComp: public CGqlRepresentationDataControllerComp
{
public:
	typedef CGqlRepresentationDataControllerComp BaseClass;

	I_BEGIN_COMPONENT(CGqlSettingsControllerComp);
