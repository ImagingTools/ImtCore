...
public:
	...
	virtual QByteArray CreateInvitation(const QByteArray& invitedByUserId, const QByteArray& userId, const QByteArray& tenantId, ITenantMembership::TenantMemberRole role) override;
