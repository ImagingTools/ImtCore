...
struct RelationshipProposalInfo
{
	...
	ITenantInfo::TenantRelationshipRole proposedSourceRole = ITenantInfo::TRR_PARTNER;
	ITenantInfo::TenantRelationshipRole proposedTargetRole = ITenantInfo::TRR_PARTNER;
