...
EjDocument* CReportProvider::getReport(iprm::IParamsSet* reportParams, const istd::IChangeable* dataObjectPtr, const iqt::ITranslationManager* translatorPtr, const QByteArray& userLanguage)
{
