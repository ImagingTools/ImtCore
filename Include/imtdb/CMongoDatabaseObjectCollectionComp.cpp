...
//		return new CDatabaseObjectCollectionIterator(sqlQuery, m_objectDelegateCompPtr.GetPtr());
	}
...
bool CMongoDatabaseObjectCollectionComp::ExecuteTransaction(const QByteArray& sqlQuery) const
{
