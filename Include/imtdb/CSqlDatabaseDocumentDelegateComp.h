...
public:
	...
	I_BEGIN_COMPONENT(CSqlDatabaseDocumentDelegateComp)
		...
		I_ASSIGN(m_externalDocumentCollectionCompPtr, "ExternalDocumentCollection", "External document coillection used as a storage of the document data", false, "ExternalDocumentCollection");
