...
const QMap<QString, QPalette::ColorRole>CImtStyleUtils::s_colorRolesNamesMap = {
...
const QMap<QString, QFont::HintingPreference> CImtStyleUtils::s_fontHintingPreferenceNamesMap = {
...
const QMap<QString, QFont::Capitalization> CImtStyleUtils::s_fontCapitalizationNamesMap = {
...
const QMap<QString, QFont::Style> CImtStyleUtils::s_fontStyleNamesMap = {
...
const QMap<QString, QFont::StyleStrategy> CImtStyleUtils::s_fontStyleStrategyNamesMap = {
...
const QMap<QString, QFont::StyleHint> CImtStyleUtils::s_fontStyleHintNamesMap = {
...
const QMap<QString, QFont::SpacingType> CImtStyleUtils::s_fontSpacingTypeNamesMap = {
...
QString CImtStyleUtils::GetColorName(QPalette::ColorGroup group, QPalette::ColorRole role)
{
...
bool CImtStyleUtils::GetColorRoleGroup(const QString& name, QPalette::ColorGroup& group, QPalette::ColorRole& role)
{
	const QStringList& groupNames = CImtStyleUtils::s_colorGroupNamesMap.keys();
...
QPalette CImtStyleUtils::GetPaletteFromEntry(const QJsonValue& paletteEntry)
{
	QPalette palette;
	...
	for(QJsonObject::const_iterator value = paletteEntryObject.constBegin(); value != paletteEntryObject.constEnd(); ++value){
		QPalette::ColorGroup colorGroup;
		QPalette::ColorRole colorRole;
		CImtStyleUtils::GetColorRoleGroup(value.key(), colorGroup, colorRole);

		QColor color;
		if (!CImtStyleUtils::CreateColorFromGrb(value->toString(), color)){
...
bool CImtStyleUtils::CreateColorFromGrb(const QString& rgbString, QColor& color)
{
...
bool CImtStyleUtils::GetFontHintingPreference(const QString& name, QFont::HintingPreference& hintingPreference)
{
...
bool CImtStyleUtils::GetFontCapitalization(const QString& name, QFont::Capitalization& capitalization)
{
...
bool CImtStyleUtils::GetFontStyle(const QString& name, QFont::Style& style)
{
...
bool CImtStyleUtils::GetFontStyleStrategy(const QString& name, QFont::StyleStrategy& styleStrategy)
{
...
bool CImtStyleUtils::GetFontStyleStrategy(const QStringList& names, QFont::StyleStrategy& styleStrategy)
{
	int output = 0x0000;
...
bool CImtStyleUtils::GetFontStyleHint(const QString& name, QFont::StyleHint& styleHint)
{
...
bool CImtStyleUtils::GetFontSpacingType(const QString& name, QFont::SpacingType& spacingType)
{
...
bool CImtStyleUtils::GetFontsFromEntry(const QJsonValue& fontsEntry, QMap<QByteArray, QFont>& fonts, imtbase::CCollectionInfo* fontsCollectionInfo)
{
