...
class CDesignTokenCommonQrcGeneratorComp: public ilog::CLoggerComponentBase, public IDesignTokenQrcUpdater, public IDesignTokenProcessor
{
public:
	typedef ilog::CLoggerComponentBase BaseClass;

	I_BEGIN_COMPONENT(CDesignTokenCommonQrcGeneratorComp);
