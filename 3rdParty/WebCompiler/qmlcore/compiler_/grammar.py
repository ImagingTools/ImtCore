...
identifier = Word(srange("[A-Za-z_]"), alphanums + "_")
...
nested_identifier_lvalue = Word(srange("[A-Za-z_]"), alphanums + "._")

nested_identifier_rvalue = Word(srange("[A-Za-z_]"), alphanums + "._")
