...
exports.initSystem = function(system) {
	...
	win.on('focus', function() { 
		...
		system.pageActive = true 
	})
	win.on('blur', function() { 
		system.pageActive = false 
	})
...
var _queueAnimations = []
var _timerAnimation = setInterval(()=>{_queueAnimations.forEach(obj => obj._tick())}, _fpsInterval)

exports.pushAnimation = function(obj){
	_queueAnimations.push(obj)
}
