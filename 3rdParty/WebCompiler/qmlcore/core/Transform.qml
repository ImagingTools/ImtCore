...
Object {
	...
	property real scale; //by Artur, horizontal scale and vertical scale
	...
	onScaleChanged:		{ this._transforms.add('scaleY', value); this._transforms.add('scaleX', value); this._updateTransform() }
