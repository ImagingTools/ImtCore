...
set "LIBRARIES=EJ QXlsx WebCompiler boost icu libduckdb libmdbx mongoc mongocxx nodejs openssl pybind11 quazip zlib zstd"
...
:generate_add_submodules_script
    ...
    (
        ...
        echo set "LIBRARIES=EJ QXlsx WebCompiler boost icu libduckdb libmdbx mongoc mongocxx nodejs openssl pybind11 quazip zlib zstd"
        echo.
