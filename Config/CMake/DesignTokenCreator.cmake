...
if(ANDROID)
	set(DESIGN_TOKEN_CREATOR_EXE_BIN "${IMTCOREDIR_BUILD}/Bin/${CMAKE_BUILD_TYPE}_$ENV{ARXCHOST}/${DESIGN_TOKEN_CREATOR_EXE}")
else()
	set(DESIGN_TOKEN_CREATOR_EXE_BIN "${IMTCOREDIR_BUILD}/Bin/${COMPILER_DIR}/${DESIGN_TOKEN_CREATOR_EXE}")
endif()
...
set(DESIGN_TOKEN_CREATOR_COMMAND_PARAMS
	...
	-S
		${DESIGN_TOKEN_CREATOR_COMMAND_PARAM_STYLES_INPUT_DIR}
	-OD
...
file(GLOB DESIGN_TOKEN_CREATOR_COMMAND_PARAM_STYLES_INPUT_FILES "${DESIGN_TOKEN_CREATOR_COMMAND_PARAM_STYLES_INPUT_DIR}/*")
...
if(DESIGN_TOKEN_CREATOR_COMMAND_PARAM_STYLES_INPUT_DIR)
	string(LENGTH ${DESIGN_TOKEN_CREATOR_COMMAND_PARAM_STYLES_INPUT_DIR} STYIES_INPUT_DIR_LENGTH)
endif()
...
if(STYIES_INPUT_DIR_LENGTH GREATER 2)
	list(APPEND DESIGN_TOKEN_SOURCE_FILES ${DESIGN_TOKEN_CREATOR_COMMAND_PARAM_STYLES_INPUT_FILES})
endif()
list(APPEND DESIGN_TOKEN_SOURCE_FILES ${DESIGN_TOKEN_CREATOR_INPUT_THEME_FILES})

message(VERBOSE "DESIGN_TOKEN_CREATOR_COMMAND_PARAM_IMAGES_INPUT_DIR ${DESIGN_TOKEN_CREATOR_COMMAND_PARAM_IMAGES_INPUT_DIR}")
message(VERBOSE "DESIGN_TOKEN_CREATOR_COMMAND_PARAM_OUTPUT_DIR ${DESIGN_TOKEN_CREATOR_COMMAND_PARAM_OUTPUT_DIR}")
message(VERBOSE "DESIGN_TOKEN_SOURCE_FILES ${DESIGN_TOKEN_SOURCE_FILES}")


set(QRC_CPP_COMMON_CURRENT_FILE ${DESIGN_TOKEN_CREATOR_COMMAND_PARAM_OUTPUT_DIR}/qrc_${LOWER_PROJECT_NAME}Common.cpp)
set(QRC_QRC_COMMON_CURRENT_FILE ${DESIGN_TOKEN_CREATOR_COMMAND_PARAM_OUTPUT_DIR}/${LOWER_PROJECT_NAME}Common.qrc)
...
foreach(_file ${DESIGN_TOKEN_CREATOR_INPUT_THEME_FILES})
	...
	set(QRC_QRC_LAST_FILE ${DESIGN_TOKEN_CREATOR_COMMAND_PARAM_OUTPUT_DIR}/${LOWER_PROJECT_NAME}${CURRENT_FILE_NAME}.qrc)
endforeach()
...
add_custom_command(
	...
	ARGS
		${DESIGN_TOKEN_CREATOR_COMMAND_PARAMS} QT_QPA_PLATFORM=offscreen -F ${DESIGN_TOKEN_CREATOR_INPUT_THEME_FILES} --ignore-errors
	DEPENDS
		${DESIGN_TOKEN_CREATOR_EXE_BIN} ${QRC_QRC_FILES} ${DESIGN_TOKEN_SOURCE_FILES}
		COMMENT
		"[DesignToken::${LOWER_PROJECT_NAME}] Creating QRC COMMON ${QRC_QRC_COMMON_CURRENT_FILE}"
VERBATIM
	)

message(VERBOSE "${DESIGN_TOKEN_CREATOR_EXE_BIN} ARGS ${DESIGN_TOKEN_CREATOR_COMMAND_PARAMS} -F ${DESIGN_TOKEN_CREATOR_INPUT_THEME_FILES} --ignore-errors")

set(QRC_CPP_WEB_CURRENT_FILE ${DESIGN_TOKEN_CREATOR_COMMAND_PARAM_OUTPUT_DIR}/qrc_${LOWER_PROJECT_NAME}Theme.cpp)
set(QRC_QRC_WEB_CURRENT_FILE ${DESIGN_TOKEN_CREATOR_COMMAND_PARAM_OUTPUT_DIR}/${LOWER_PROJECT_NAME}Theme.qrc)
...
add_custom_command(
	...
	COMMAND
		${DESIGN_TOKEN_CREATOR_EXE_BIN}
	ARGS
		${DESIGN_TOKEN_CREATOR_COMMAND_PARAMS} -W --ignore-errors
	DEPENDS
		${DESIGN_TOKEN_CREATOR_EXE_BIN} ${QRC_QRC_LAST_FILE}
	COMMENT
...
add_custom_command(
	...
	ARGS
		-name ${PROJECT_NAME}Theme ${QRC_QRC_WEB_CURRENT_FILE} -o ${QRC_CPP_WEB_CURRENT_FILE}
	DEPENDS
		${QRC_QRC_WEB_CURRENT_FILE}
		COMMENT
...
foreach(_file ${DESIGN_TOKEN_CREATOR_INPUT_THEME_FILES})
	...
	add_custom_command(
		...
		DEPENDS
			${DESIGN_TOKEN_SOURCE_FILES} ${QRC_CPP_WEB_CURRENT_FILE}
		COMMENT
