...
macro(GetSdlGeneratorPath OUTPUT_SDL_GENERATOR_EXE_PATH)
	...
	if(ANDROID)
		set(SDL_GENERATOR_EXE_PATH "${BUILDDIR}/ImtCore/Bin/${CMAKE_BUILD_TYPE}_$ENV{ARXCHOST}/${SDL_GENERATOR_EXE_NAME}")
	else()
		set(SDL_GENERATOR_EXE_PATH "${BUILDDIR}/ImtCore/Bin/${COMPILER_DIR}/${SDL_GENERATOR_EXE_NAME}")
	endif()
