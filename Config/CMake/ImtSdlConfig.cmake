...
#	set(IMT_SDL_BIN_DIR_INTERNAL "${IMTCOREDIR}/Bin/" CACHE INTERNAL "INTERNAL. Dir where an SDL generator is located.")
	...
	if(ANDROID)
			set(SDL_GENERATOR_EXE_PATH "${IMT_SDL_BIN_DIR_INTERNAL}/${CMAKE_BUILD_TYPE}_$ENV{ARXCHOST}/${SDL_GENERATOR_EXE_NAME}")
	else()
			set(SDL_GENERATOR_EXE_PATH "${IMT_SDL_BIN_DIR_INTERNAL}/${COMPILER_DIR}/${SDL_GENERATOR_EXE_NAME}")
	endif()
