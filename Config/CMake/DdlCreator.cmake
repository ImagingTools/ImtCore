...
elseif(APPLE)
	set(DDL_CODE_CREATOR_EXE "DdlCodeCreator.app/Contents/MacOS/DdlCodeCreator")
else()
...
if(ANDROID)
	set(DDL_CODE_CREATOR_EXE_BIN "${IMTCOREDIR_BUILD}/Bin/${CMAKE_BUILD_TYPE}_$ENV{ARXCHOST}/${DDL_CODE_CREATOR_EXE}")
else()
	set(DDL_CODE_CREATOR_EXE_BIN "${IMTCOREDIR_BUILD}/Bin/${COMPILER_DIR}/${DDL_CODE_CREATOR_EXE}")
endif()
