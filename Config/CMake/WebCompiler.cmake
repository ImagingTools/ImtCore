...
function(compile_web)
	...
	message(VERBOSE "QRC_CPP_WEB_FILE ${QRC_CPP_WEB_FILE}")
	list(APPEND webdirs_n C:/Projects/web/dist)
	list(APPEND webdirs_n ${buildwebdir}/Resources)

	message("PREPARE RESOURCES ${PYTHONEXE} C:/Projects/web/preparesources.py ${webdirs_n}")
	...
	add_custom_command(
		...
		POST_BUILD
		COMMAND ${CMAKE_COMMAND} -E make_directory ${buildwebdir}
		COMMAND ${PYTHONEXE} C:/Projects/web/preparesources.py ${webdirs_n}
		WORKING_DIRECTORYC:/Projects/web
		COMMAND ${CMAKE_COMMAND} -E env
		TARGETNAME=${TARGETNAME}
		${NODE_EXE}
		C:/Projects/web/compiler/compiler.js
		-n index
		-i ${appicon}
		-o ${buildwebdir}/Resources/
		-m html
	...
	add_custom_command(
		...
		${buildwebdir}/Resources/index.js
		POST_BUILD
		WORKING_DIRECTORY C:/Projects/web
		COMMAND ${CMAKE_COMMAND} -E env
		TARGETNAME=${TARGETNAME}
		${NODE_EXE}
		C:/Projects/web/compiler/compiler.js
