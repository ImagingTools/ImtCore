...
macro(getImtTagQmlWebDirs webdirs buildwebdir)
	list(APPEND ${webdirs} ${IMTCOREDIR}/Qml/imttaggui)
	list(APPEND ${webdirs} ${buildwebdir}/src/imttaggui)

	list(APPEND ${webdirs} ${IMTCOREDIR_BUILD}/AuxInclude/${TARGETNAME}/GeneratedFiles/imttagsdl/SDL/1.0/QML/imttagTagsSdl)
	list(APPEND ${webdirs} ${buildwebdir}/src/imttagTagsSdl)
endmacro(getImtTagQmlWebDirs)
...
macro(getImtCoreQmlWebDirs webdirs buildwebdir)
	...
	getImtTagQmlWebDirs(${webdirs} ${buildwebdir})
