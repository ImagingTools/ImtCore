...
foreach(_file ${QDESIGN_TOKEN_CREATOR_OUTPUT_FILE_NAMES})

	set(QRC_CPP_CURRENT_FILE ${DESIGN_TOKEN_CREATOR_COMMAND_PARAM_OUTPUT_DIR}/qrc_${_file}.cpp)
...
foreach(_file ${QDESIGN_TOKEN_CREATOR_OUTPUT_FILE_NAMES})
	...
	set(QRC_QRC_CURRENT_FILE ${DESIGN_TOKEN_CREATOR_COMMAND_PARAM_OUTPUT_DIR}/${_file}.qrc)
	set(QRC_CPP_CURRENT_FILE ${DESIGN_TOKEN_CREATOR_COMMAND_PARAM_OUTPUT_DIR}/qrc_${_file}.cpp)
	...
	add_custom_command(
		...
		COMMENT
			"[DesignToken::${PROJECT_NAME}] Creating OUTPUT ${QRC_QRC_CURRENT_FILE}"
		VERBATIM
		)
	...
	add_custom_command(
		...
		ARGS
			-name ${_file} ${QRC_QRC_CURRENT_FILE} -o ${QRC_CPP_CURRENT_FILE}
		DEPENDS
			${QRC_QRC_CURRENT_FILE}
		COMMENT
			"[DesignToken::${PROJECT_NAME}] CREATING ${QRC_CPP_CURRENT_FILE}"
	)
