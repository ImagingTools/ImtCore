...
set(DESIGN_TOKEN_CREATOR_COMMAND_PARAM_FILE "${IMTCOREDIR}/Include/imtgui/Resources/DesignToken.json")
set(DESIGN_TOKEN_CREATOR_COMMAND_PARAM_INPUT_DIR "${IMTCOREDIR}/Include/imtgui/Resources/Icons/Template")
set(DESIGN_TOKEN_CREATOR_COMMAND_PARAM_OUTPUT_DIR "${IMTCOREDIR}/Include/imtgui/Resources/Icons/Output")
...
add_custom_command(
	OUTPUT
		${DESIGN_TOKEN_CREATOR_COMMAND_PARAM_OUTPUT_DIR}/designToekn.stamp
	COMMAND
		${DESIGN_TOKEN_CREATOR_EXE_BIN}
	ARGS
		${DESIGN_TOKEN_CREATOR_COMMAND_PARAMS}
	COMMAND
		${CMAKE_COMMAND} -E touch ${DESIGN_TOKEN_CREATOR_COMMAND_PARAM_OUTPUT_DIR}/designToekn.stamp
	COMMENT
...
add_custom_target(
	designToekn ALL
	DEPENDS ${DESIGN_TOKEN_CREATOR_COMMAND_PARAM_OUTPUT_DIR}/designToekn.stamp
	)
