...
declare_target_dependencies(imttagsdl				imtbasesdl imttag)
...
declare_target_dependencies(imtaccount				imtbase Acf::iimg)
...
declare_target_dependencies(imtauthgui				imtaccount imtgui imtqml)
...
declare_target_dependencies(imttag					imtauth imtcol)
declare_target_dependencies(imttagdb				imtdb imttag Qt${QT_VERSION_MAJOR}::Sql)
declare_target_dependencies(imttaggql				imttagsdl imtservergql imtlic)
declare_target_dependencies(controlsgallerygql		controlsgallerysdl imtservergql imtbase imtcrypt imtaccount imtauth imtdoc imtdb imtbasesdl)
...
declare_target_dependencies(imtlicgql				imtaccount imtguigql imtlicsdl imtwidgets)
declare_target_dependencies(imtlicgui				imtaccount imtauth imtgui imtlic)
...
declare_target_dependencies(imttagguiqml			imtqml imtgui)
...
declare_target_dependencies(ImtCoreLoc				AcfSln::AcfSlnLoc)
