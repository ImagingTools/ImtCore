...
#------ Required libs ------
imt_declare_library_dependencies(imtbase		AcfSln::iauth AcfSln::icomm AcfSln::iinsp AcfSln::imeas imtfile)
imt_declare_library_dependencies(imtdesign		imtbase)
imt_declare_library_dependencies(imtfile		Acf::ifile AcfSln::ifileproc)
...
imt_declare_library_dependencies(imtsdlgencpp	AcfSln::iproc imtsdl)
...
if(NOT IMT_BUILD_TOOLS_ONLY)
	...
	imt_declare_library_dependencies(imtrest				imtbase imtcom imtservergql)
	imt_declare_library_dependencies(imtstyle				imtbase imtdesign)
	imt_declare_library_dependencies(imtgql					imtauth imtrest)
	imt_declare_library_dependencies(imtservergql			imtauthsdl imtappsdl imtclientgql imtcol imtcom imtdoc imtgql imthype imtrest imtserverapp)
	imt_declare_library_dependencies(imtauthgql				imtauthsdl imtclientgql imtdb imtrest imtserverapp imtservergql)
	...
	imt_declare_library_dependencies(imtauth				Acf::iimg imtcrypt imtdoc imtlic imtmail)
	...
	imt_declare_library_dependencies(imtcom             	imtbase imtclientgql imtrest)
	...
	imt_declare_library_dependencies(imtserverapp       	Acf::icmm imtclientgql imtcom imtdb imtgql imtlic imtqml imtrest imtsdl imtservice)
...
endif() # NOT IMT_BUILD_TOOLS_ONLY
