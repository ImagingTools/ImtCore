...
SDL_FWD_MOC_COMPILER.commands = $${QMAKE_MOC} $${SDL_GENERATOR_OUT_SUBFOLDER}/$${TARGET}/SDL/1.0/CPP/${QMAKE_FILE_BASE}_fwd.h -o $${SDL_GENERATOR_OUT_SUBFOLDER}/$${TARGET}/SDL/1.0/CPP/moc_${QMAKE_FILE_BASE}_fwd.cpp
SDL_FWD_MOC_COMPILER.input = SDL_SCHEMES_LIST
SDL_FWD_MOC_COMPILER.output = $${SDL_GENERATOR_OUT_SUBFOLDER}/$${TARGET}/SDL/1.0/CPP/moc_${QMAKE_FILE_BASE}_fwd.cpp
...
SDL_FWD_MOC_COMPILER.depends = $${SDL_GENERATOR_OUT_SUBFOLDER}/$${TARGET}/SDL/1.0/CPP/${QMAKE_FILE_BASE}.h $${SDL_GENERATOR_BIN}
