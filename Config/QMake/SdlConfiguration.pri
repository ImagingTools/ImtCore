...
# Build SDL_FWD_HEADER_LIST: for each .sdl scheme derive the generated _fwd.h path
for(sdl_scheme, SDL_SCHEMES_LIST) {
	sdl_base = $$basename(sdl_scheme)
	sdl_base ~= s/\.sdl$//
	SDL_FWD_HEADER_LIST += $${SDL_GENERATOR_OUT_SUBFOLDER}/$${TARGET}/SDL/1.0/CPP/$${sdl_base}_fwd.h
}
win32{
	SDL_FWD_HEADER_LIST ~= s,/,\\,g
}
...
SDL_MOC_COMPILER.commands = $${QMAKE_MOC} $${SDL_GENERATOR_OUT_SUBFOLDER}/$${TARGET}/SDL/1.0/CPP/${QMAKE_FILE_BASE}.h -o $${SDL_GENERATOR_OUT_SUBFOLDER}/$${TARGET}/SDL/1.0/CPP/moc_${QMAKE_FILE_BASE}.cpp
...
SDL_FWD_MOC_COMPILER.name = SDL_FWD_MOC_Compiler-$${TARGET}
SDL_FWD_MOC_COMPILER.commands = $${QMAKE_MOC} ${QMAKE_FILE_IN} -o $${SDL_GENERATOR_OUT_SUBFOLDER}/$${TARGET}/SDL/1.0/CPP/moc_${QMAKE_FILE_BASE}.cpp
SDL_FWD_MOC_COMPILER.input = SDL_FWD_HEADER_LIST
SDL_FWD_MOC_COMPILER.output = $${SDL_GENERATOR_OUT_SUBFOLDER}/$${TARGET}/SDL/1.0/CPP/moc_${QMAKE_FILE_BASE}.cpp
SDL_FWD_MOC_COMPILER.dependency_type = TYPE_C
SDL_FWD_MOC_COMPILER.variable_out = SOURCES
SDL_FWD_MOC_COMPILER.CONFIG = target_predeps
SDL_FWD_MOC_COMPILER.depends = ${QMAKE_FILE_IN} $${SDL_GENERATOR_BIN}
QMAKE_EXTRA_COMPILERS += SDL_FWD_MOC_COMPILER


SDL_QRC_COMPILER.name = SDL_QRC_Compiler-$${TARGET}
SDL_QRC_COMPILER.commands = $${QMAKE_RCC} $${SDL_GENERATOR_OUT_SUBFOLDER}/$${TARGET}/SDL/1.0/QML/${QMAKE_FILE_BASE}/${QMAKE_FILE_BASE}.qrc -name ${QMAKE_FILE_BASE} -o $${SDL_GENERATOR_OUT_SUBFOLDER}/$${TARGET}/SDL/1.0/CPP/qrc_${QMAKE_FILE_BASE}.cpp
