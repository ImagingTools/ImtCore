...
SDL_MOC_COMPILER.commands = $${QMAKE_MOC} ${QMAKE_FILE_IN} -o $${SDL_GENERATOR_OUT_SUBFOLDER}/$${TARGET}/SDL/1.0/CPP/moc_${QMAKE_FILE_BASE}.cpp && $${QMAKE_MOC} ${QMAKE_FILE_IN_BASE}_fwd.h -o $${SDL_GENERATOR_OUT_SUBFOLDER}/$${TARGET}/SDL/1.0/CPP/moc_${QMAKE_FILE_BASE}_fwd.cpp
...
SDL_FWD_MOC_FILES = $$replace(SDL_SCHEMES_LIST, \\.sdl$, )
for(_sdlFile, SDL_FWD_MOC_FILES) {
	_sdlBase = $$basename(_sdlFile)
	SOURCES += $${SDL_GENERATOR_OUT_SUBFOLDER}/$${TARGET}/SDL/1.0/CPP/moc_$${_sdlBase}_fwd.cpp
}
