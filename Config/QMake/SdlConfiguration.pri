...
SDL_FWD_H_COMPILER.name = SDL_Compiler_FwdHeader-$${TARGET}
SDL_FWD_H_COMPILER.commands = $${SDL_CXX_GENERATOR_COMMAND_BASE} -GS ${QMAKE_FILE_IN} --config=$${SDL_GENERATOR_CONFIG_PATH} --cpp-mode=HEADER
SDL_FWD_H_COMPILER.input = SDL_SCHEMES_LIST
SDL_FWD_H_COMPILER.output = $${SDL_GENERATOR_OUT_SUBFOLDER}/$${TARGET}/SDL/1.0/CPP/${QMAKE_FILE_BASE}_fwd.h
SDL_FWD_H_COMPILER.dependency_type = TYPE_C
SDL_FWD_H_COMPILER.variable_out = SDL_FWD_HEADERS
SDL_FWD_H_COMPILER.CONFIG = target_predeps
SDL_FWD_H_COMPILER.depends = ${QMAKE_FILE_IN} $${SDL_GENERATOR_BIN}
QMAKE_EXTRA_COMPILERS += SDL_FWD_H_COMPILER
