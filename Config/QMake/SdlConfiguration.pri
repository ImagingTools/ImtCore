...
for(SDL_SCHEMA_PATH, SDL_SCHEMES_LIST) {
	SDL_SCHEMA_BASE = $$basename($$SDL_SCHEMA_PATH)
	SDL_FWD_HEADERS += $${SDL_GENERATOR_OUT_SUBFOLDER}/$${TARGET}/SDL/1.0/CPP/$${SDL_SCHEMA_BASE}_fwd.h
}
HEADERS += $$SDL_FWD_HEADERS
