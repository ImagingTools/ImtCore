...
message ("CPP_SDL_OUTPUT_FILES_QML '$${CPP_SDL_OUTPUT_FILES_QML}'")
...
qmlSdlCompiler$${TARGET}.output = $$CPP_SDL_OUTPUT_FILES_QML
qmlSdlCompiler$${TARGET}.commands = $$SDL_GENERATOR_COMMAND_BASE -G --QML -N=$${SDL_GENERATOR_QML_MODULE_NAME} -O=$${SDL_GENERATOR_QML_OUT_SUBFOLDER} && $${GENERATE_RESOURCE_COMMANDS}
