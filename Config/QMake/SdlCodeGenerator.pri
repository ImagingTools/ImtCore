...
defineReplace(CreateSdlTarget) {
	...
	SDL_GENERATED_FILES = $$system($${SDL_GENERATOR_COMMAND_BASE} -DS $${SDL_GENERATOR_SCHEME_PATH} --GG=2 --config=$${SDL_GENERATOR_CONFIG_PATH})
	...
	$${SDL_COMPILER_NAME}.commands = $${SDL_GENERATOR_COMMAND_BASE} -GS $${SDL_GENERATOR_SCHEME_PATH} --GG=2 --config=$${SDL_GENERATOR_CONFIG_PATH}
...
defineReplace(CreateQmlSdlTarget) {
	...
	SDL_GENERATOR_COMMAND_BASE = $$SDL_GENERATOR_BIN $$SDL_GENERATOR_COMMAND_PARAM_MODIFICATORS --auto-join --generator=QMake -O=$${SDL_GENERATOR_OUT_SUBFOLDER} --config=$${SDL_GENERATOR_QML_CONFIG_PATH}
	win32{
		SDL_GENERATOR_COMMAND_BASE ~= s,/,\\,g
	}
