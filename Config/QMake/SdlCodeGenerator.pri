...
SDL_GENERATOR_OUT_SUBFOLDER = $$OUT_PWD/../../../$$AUXINCLUDEDIR/GeneratedFiles/$$TARGET/SDL
...
defineReplace(CreateSdlTarget) {
	...
	SDL_GENERATED_FILES = $$system($${SDL_GENERATOR_COMMAND_BASE} -DS $${SDL_GENERATOR_SCHEME_PATH} --CPP --GQL -Psdl)
...
message("SDL PATHS FOR $$TARGET IS $$SDL_EXTRA_INCLUDES_DIRECTIVE")
	...
	$${SDL_COMPILER_NAME}.commands = $${SDL_GENERATOR_COMMAND_BASE} -GS $${SDL_GENERATOR_SCHEME_PATH} --CPP --GQL -Psdl --auto-link=2 $$SDL_EXTRA_INCLUDES_DIRECTIVE
