...
DESIGN_TOKEN_CREATOR_INPUT_THEME_FILES = $$files($$(IMTCOREDIR)/Include/imtstyle/*.theme, false)

DESIGN_TOKEN_CREATOR_COMMAND_PARAMS = -F ${QMAKE_FILE_IN} -I $$DESIGN_TOKEN_CREATOR_COMMAND_PARAM_IMAGES_INPUT_DIR -S $$DESIGN_TOKEN_CREATOR_COMMAND_PARAM_STYIES_INPUT_DIR -OD $$DESIGN_TOKEN_CREATOR_COMMAND_PARAM_OUTPUT_DIR -P $$TARGET
DESIGN_TOKEN_CREATOR_COMMAND = $$DESIGN_TOKEN_CREATOR_EXE_BIN $$DESIGN_TOKEN_CREATOR_COMMAND_PARAMS -env_vars $$ENV_VARS


GENERATE_RESOURCE_COMMANDS = $$[QT_INSTALL_BINS]/$$QMAKE_RCC -name $$TARGET${QMAKE_FILE_BASE} $${DESIGN_TOKEN_CREATOR_COMMAND_PARAM_OUTPUT_DIR}/$$TARGET${QMAKE_FILE_BASE}.qrc -o $${DESIGN_TOKEN_CREATOR_COMMAND_PARAM_OUTPUT_DIR}/qrc_$$TARGET${QMAKE_FILE_BASE}.cpp
GENERATED_RESOURCE_OUTPUT = $${DESIGN_TOKEN_CREATOR_COMMAND_PARAM_OUTPUT_DIR}/qrc_$$TARGET${QMAKE_FILE_BASE}.cpp
