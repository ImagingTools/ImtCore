...
DESIGN_TOKEN_CREATOR_WEB_PARAMS = -I $$DESIGN_TOKEN_CREATOR_COMMAND_PARAM_IMAGES_INPUT_DIR -S $$DESIGN_TOKEN_CREATOR_COMMAND_PARAM_STYIES_INPUT_DIR -OD $$DESIGN_TOKEN_CREATOR_COMMAND_PARAM_OUTPUT_DIR -P $$LOWER_TARGET
DESIGN_TOKEN_CREATOR_WEB_COMMAND = $$DESIGN_TOKEN_CREATOR_EXE_BIN $$DESIGN_TOKEN_CREATOR_WEB_PARAMS
...
GENERATE_THEME_RESOURCE_COMMANDS = $$[QT_INSTALL_BINS]/$$QMAKE_RCC -name $${LOWER_TARGET}Theme $${QRC_THEME_CURRENT_FILE} -o $${GENERATED_THEME_RESOURCE_OUTPUT}
...
themes$${TARGET}.commands = $${DESIGN_TOKEN_CREATOR_COMMAND} --ignore-errors && $${GENERATE_RESOURCE_COMMANDS} # && $${GENERATE_THEME_RESOURCE_COMMANDS}
themes$${TARGET}.input = THEME_FILES
themes$${TARGET}.output = $${GENERATED_RESOURCE_OUTPUT}
#themes$${TARGET}.depend_command = $${GENERATE_THEME_RESOURCE_COMMANDS}
...
webthemes$${TARGET}.name = Theme Files
webthemes$${TARGET}.commands = $${DESIGN_TOKEN_CREATOR_WEB_COMMAND} -W --ignore-errors && $${GENERATE_THEME_RESOURCE_COMMANDS}
webthemes$${TARGET}.input = THEME_FILES
webthemes$${TARGET}.output = $${GENERATED_THEME_RESOURCE_OUTPUT}
webthemes$${TARGET}.dependency_type = TYPE_C
webthemes$${TARGET}.variable_out = SOURCES
webthemes$${TARGET}.CONFIG += no_link target_predeps
QMAKE_EXTRA_COMPILERS += webthemes$${TARGET}
