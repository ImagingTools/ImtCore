...
void CStructurePartituraTestBase::cleanup()
{
	//initTestCase();
...
void CStructurePartituraTestBase::InsertObjectWithRequiredParamsTest_data()
{
	...
	QTest::newRow("description param is empty") << QByteArray("83465a08-b435-44b8-99e3-b2e72e50b205") << QByteArray("TestInfo") << "TestObjectName" << "" << "AccountName3" << QByteArray("2678168c-c55f-4212-ba35-d1880a21bce7") << false;
	QTest::newRow("type id is not exist") << QByteArray("83465a08-b435-44b8-99e3-b2e72e50b205") << QByteArray("AnotherTypeId") << "TestObjectName" << "Insert object with non-exist type id" << "AccountName4" << QByteArray("2278168c-c55f-4212-ba35-d1880a21bce7") << true;
	QTest::newRow("object id is exist") << QByteArray("83465a08-b435-44b8-99e3-b2e72e50b205") << QByteArray("TestInfo") << "TestObjectName" << "Insert object with exist type id and all params is setted" << "AccountName5" << QByteArray("2278168c-c55f-4212-ba35-d1880a21bce7") << false;
...
void CStructurePartituraTestBase::MoveObjectTest()
{
	...
	if (compositePtr.IsValid()) {
		...
		if (hierarchicalStructurePtr != nullptr) {
			...
			bool result = hierarchicalStructurePtr->MoveObject("2278168c-c55f-4212-ba35-d1880a21bce7", "83465a08-b435-44b8-99e3-b2e72e50b205", "ac0d4bcf-73bc-4bd7-9263-c914d41591ba");
...
void CStructurePartituraTestBase::RemoveObjectTest()
{
	...
	if (compositePtr.IsValid()) {
		...
		if (hierarchicalStructurePtr != nullptr) {
			...
			bool result = hierarchicalStructurePtr->RemoveObject("2278168c-c55f-4212-ba35-d1880a21bce7", "ac0d4bcf-73bc-4bd7-9263-c914d41591ba");
