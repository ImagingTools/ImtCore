...
Документация по фундаментальным QML-модулям ImtCore, на которых строятся прикладные модули (каталог — [STRUCTURE-app.md](STRUCTURE-app.md)). Обзор и навигация — в [README.md](../README.md); правила размещения новых компонентов — в [STRUCTURE.md](STRUCTURE.md).
