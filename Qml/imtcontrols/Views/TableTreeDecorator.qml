...
//        cells.setData("BorderColorHorizontal", Style.tableHeaderBorederColor);
//        cells.setData("BorderColorVertical", Style.tableHeaderBorederColor);
		...
		cellWidth.setData("MinWidth", Style.sizeHintBXS);
